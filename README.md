...
│   └── nfqws             # Основной исполняемый файл zapret
├── src/                   # Исходный код
├── data/                  # 📁 Пользовательские данные
│   ├── strategies/        # Сгенерированные стратегии
│   ├── repo.list         # Пользовательский список репозиториев
│   └── conf.json         # Конфигурация
├── repos/                 # Клонированные репозитории
├── repo.list.default     # Шаблон списка репозиториев
├── main_script.sh        # Основной скрипт
├── service.sh            # Скрипт управления сервисом
├── stop_and_clean_nft.sh # Скрипт очистки nftables
└── zapret-rs             # Основной исполняемый файл
```
